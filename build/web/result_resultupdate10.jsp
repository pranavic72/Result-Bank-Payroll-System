<%-- 
    Document   : result_resultupdate10
    Created on : Jan 13, 2022, 3:05:47 AM
    Author     : DELL
--%>
...
<h1>Update Student Results</h1>
            <table class="data">
                ...
                <tr>
                    ...
                    <td>
                        <form action='result_resultupdate10.jsp' method="post">
                            <input type="text" class="input" name="sub1" value="<%= sub1%>"/>
                            <input type="hidden" class="input" name="id" value="<%= id%>"/>
                            <input type="hidden" class="input" name="trim" value="<%= trim%>"/>
                    </td>
                    <td>
...
//                        out.println(s4);
//                        out.println(s5);
                        if (id != null && trim != null && s1 != null && s2 != null && s3 != null && s4 != null && s5 != null) {
                            ...
                            String update = "update " + trim + " set sub1='" + s1 + "',sub2='" + s2 + "',sub3='" + s3 + "',sub4='" + s4 + "',sub5='" + s5 + "' where id=" + id + "";
