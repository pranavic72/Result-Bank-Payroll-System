...
public final class result_005faddnewstudent_jsp extends org.apache.jasper.runtime.HttpJspBase
...
//            String id = request.getParameter("id");
            try {
                ...
                if (fname != null && lname != null && course != null && batch != null && email != null && phone != null && address != null) {
                    ...
                    String query2 = "Insert into users(fname,lname,type,email,password) values ('" + fname + "','" + lname + "','" + type + "','" + email + "','" + email + "','" + password + "')";
